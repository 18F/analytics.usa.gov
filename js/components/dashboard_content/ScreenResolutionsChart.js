...
/**
 * Retrieves the screen resolution report from the passed data URL and creates a
 * visualization for the breakdown of screen resolutions of users visiting sites
...
function ScreenResolutionsChart({ dataHrefBase }) {
  const reportFilters = [
    ...
    ["Current Year", "screen-resolution-current-year"],
    ["Current Fiscal Year", "screen-resolution-current-fiscal-year"],
    ["Previous Year", "screen-resolution-previous-year"],
...
ScreenResolutionsChart.propTypes = {
  dataHrefBase: PropTypes.string.isRequired,
};

export default ScreenResolutionsChart;
